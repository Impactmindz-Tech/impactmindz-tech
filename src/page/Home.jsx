        ...
        <Container>
          <div className='flex md:block'>
            <div className='w-1/2 md:w-full'>
              ...
              <h1 >Real Estate <br /> Investment <br /> For <span className='text-blue-500'> Everyone </span></h1>
            ...
            <div className='w-1/2 md:w-full absolute md:static right-0 bottom-[6rem]'>
              <img className='w-[59vw] h-auto ' src="https://real-estate-sable-pi.vercel.app/_next/image?url=%2F_next%2Fstatic%2Fmedia%2Fhero-illustration.ee80d5d2.png&w=1200&q=75" alt="" />
            </div>
          </div>
        </Container>
      </section>
        ...
        <Container>
          <div className='flex items-center'>
            ...
            <div className='w-1/2 flex items-center gap-8'>
              ...
              <div className='w-1/2 flex flex-col gap-4 hover:-translate-y-2 transition-all'>
